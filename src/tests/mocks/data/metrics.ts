...
export const mockMetrics: MetricsSummary = {
  ...
  byCategory: [
    { categoryId: 'cat-1', categoryName: 'Comida', categoryIcon: '🍔', usd: 186, uyu: 3200, expenseCount: 8, expenseCountUsd: 2, expenseCountUyu: 6 },
    { categoryId: 'cat-5', categoryName: 'Hogar', categoryIcon: '🏠', usd: 0, uyu: 5180, expenseCount: 3, expenseCountUsd: 0, expenseCountUyu: 3 },
    { categoryId: 'cat-3', categoryName: 'Transporte', categoryIcon: '🚌', usd: 0, uyu: 2100, expenseCount: 5, expenseCountUsd: 0, expenseCountUyu: 5 },
    { categoryId: 'cat-6', categoryName: 'Ocio', categoryIcon: '🎬', usd: 12.98, uyu: 0, expenseCount: 2, expenseCountUsd: 2, expenseCountUyu: 0 },
    { categoryId: 'cat-4', categoryName: 'Salud', categoryIcon: '💊', usd: 0, uyu: 230, expenseCount: 1, expenseCountUsd: 0, expenseCountUyu: 1 },
  ],
  previousByCategory: [
    { categoryId: 'cat-1', categoryName: 'Comida', categoryIcon: '🍔', usd: 160, uyu: 2700, expenseCount: 7, expenseCountUsd: 2, expenseCountUyu: 5 },
    { categoryId: 'cat-5', categoryName: 'Hogar', categoryIcon: '🏠', usd: 0, uyu: 4200, expenseCount: 3, expenseCountUsd: 0, expenseCountUyu: 3 },
    { categoryId: 'cat-3', categoryName: 'Transporte', categoryIcon: '🚌', usd: 0, uyu: 2600, expenseCount: 4, expenseCountUsd: 0, expenseCountUyu: 4 },
    { categoryId: 'cat-6', categoryName: 'Ocio', categoryIcon: '🎬', usd: 12.98, uyu: 0, expenseCount: 2, expenseCountUsd: 2, expenseCountUyu: 0 },
    { categoryId: 'cat-4', categoryName: 'Salud', categoryIcon: '💊', usd: 0, uyu: 310, expenseCount: 1, expenseCountUsd: 0, expenseCountUyu: 1 },
  ],
  byProductCategory: [
